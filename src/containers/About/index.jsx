        ...
        <Item.Content>
          ...
          <Item.Description>
            <p>
              ...
              projects. It is built from zero by a single independent developer
              and an organically grown company, dismissing external funding thus
              allowing for full control of design, process and management.
            </p>
          </Item.Description>
        </Item.Content>
        <Item.Content>
          ...
          <Item.Description>
            <p>
              ...
              guidelines. This ensures maintainability, scalability and provides
              the opportunity to handover projects without steep learning
              curves.
            </p>
          </Item.Description>
        </Item.Content>
